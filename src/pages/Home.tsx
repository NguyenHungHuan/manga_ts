  ...
  return (
    <div className='container px-4 xl:px-0'>
      ...
      <section className='mt-10'>
        ...
        <ListPreviewComics data={dataRecommendComics as comics[]} />
      </section>
      <section className='mt-16'>
        ...
        <div className='flex items-end'>
          <div className='flex items-center gap-2 lg:gap-4'>
            <svg
              ...
              aria-hidden='true'
              role='img'
              className='text-primary lg:w-8 lg:h-8 w-7 h-7'
              viewBox='0 0 256 256'
              data-v-c3ad5561
            >
              <path
  ...
  return (
    <div className='flex items-end'>
      <div className='flex items-center gap-2 lg:gap-4'>
        ...
        <h2 className='capitalize font-semibold mt-1 text-2xl lg:text-[28px] text-black dark:text-white leading-5'>{title}</h2>
      </div>
      {isShowMore && (
        <Link
          to={{
